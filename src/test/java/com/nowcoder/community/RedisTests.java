...
public class RedisTests {
    ...
    public void testLists(){
        ...
        System.out.println(redisTemplate.opsForList().leftPush(redisKey,101));
        System.out.println(redisTemplate.opsForList().leftPush(redisKey,102));
        System.out.println(redisTemplate.opsForList().leftPush(redisKey,103));
...
//    多次访问同一个key
    ...
    public void testBitMapOperation(){
        ...
        String unionKey = "test:bm:union";
        Object obj = redisTemplate.execute(new RedisCallback() {
            @Override
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                connection.bitOp(RedisStringCommands.BitOperation.OR,
                        unionKey.getBytes(),redisKey2.getBytes(),redisKey3.getBytes(),redisKey4.getBytes());
